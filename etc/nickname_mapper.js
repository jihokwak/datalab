...
function onOpen() {
    ...
    var menuItems = [
        {name: 'Write table data to a sheet', functionName: 'connectToRedshiftData'}
    ];
...
*/
function connectToRedshiftData() {
...
//write rows of Redshift data to the sheet
